...
<div class="header_Item header_logo">
		...
		&nbsp;&nbsp;
		<span style="font-family: '微软雅黑';font-size: 16px;line-height: 46px;" id="pageHeaderSpan">system</span>
</div>
</div>
<div id="header_right">
...
<div class="dw_foot" style="padding-bottom: 30px;">
	<div class="footer-copyright" style="color: gray;padding-top: 0px;font-size: 16px;">
		Powered by <a href=" " target="_blank" style="text-decoration: none;color: gray;">system</a>&nbsp;&nbsp;&nbsp;
		Copyright © 2012-2017
		<a href=" " target="_blank" style="text-decoration: none;color: rgb(53, 117, 136);">system</a>
	</div>
</div>
</div>
